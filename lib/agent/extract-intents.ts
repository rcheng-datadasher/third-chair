...
• Participants (0-2): 2 = specific people are named or @mentioned in the message or in the recent channel context, or the message clearly says "you and me" (the author's own <@id> at the start of the line is the sender, NOT a named participant); 1 = nobody else is named - the audience is the whole channel/team (a bare "let's meet" or "can we sync" with no names is 1, never 2); 0 = unclear who.
